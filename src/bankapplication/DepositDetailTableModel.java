...
public class DepositDetailTableModel extends AbstractTableModel{
	...
	private ArrayList<Deposit> employees;
	
	public DepositDetailTableModel( List<Deposit> employees) {
		this.employees=(ArrayList<Deposit>) employees;
	}
	...
	public Object getValueAt(int row, int col) {
		Deposit employee=employees.get(row);
